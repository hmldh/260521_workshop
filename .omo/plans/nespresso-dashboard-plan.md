...
- [x] 1. `nespresso/` 폴더 생성 + `index.html` + `style.css` 완성
...
- [x] 2. `app.js` — capsulesData 배열 + renderCapsuleCards()
...
- [x] 3. `app.js` — 필터 이벤트 핸들러 (라인 / 강도 / 컵사이즈 / 초기화)
...
- [x] 5. 최종 정리 — 빈 상태 · 카드 수 표시 · Console 에러 0개
...
- [x] F1. `nespresso/index.html` 브라우저에서 열기
